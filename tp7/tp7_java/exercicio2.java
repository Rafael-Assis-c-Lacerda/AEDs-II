...
class Arvore2 {
    ...
    private No2 inserir(No2 i, Game game) {
        ...
        else if(game.getName().compareTo(i.elemento.getName()) > 0) i.dir = inserir(i.dir, game);
        else if(game.getName().compareTo(i.elemento.getName()) < 0) i.esq = inserir(i.esq, game);
        else;
        return i;
    }
...
public class exercicio2{
    ...
    public static void main(String []args) throws FileNotFoundException{
        ...
        try {
            PrintWriter log = new PrintWriter("885033_arvoreArvore.txt"); 
